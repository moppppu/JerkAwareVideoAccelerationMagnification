...
% Set magnification parameter (baby.mp4)
alpha = 30;
targetFreq = 1;
fs = 24;
...
! /Users/shoichirotakeda/anaconda3/bin/ffmpeg -i ./outputs/pre.avi -c:v libx264 -preset veryslow -crf 1 -pix_fmt yuv420p ./outputs/output.mp4
fprintf('\n');
